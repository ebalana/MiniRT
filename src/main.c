...
/*   Updated: 2025/07/03 16:37:35 by ebalana-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
    ...
    t_object red_sphere = create_sphere(vec3(0, 0, -1), 0.5, vec3(1.0, 0.0, 0.0));
    ...
    render_scene(img, scene);  // Pasar la escena
