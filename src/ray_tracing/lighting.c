...
/*   Updated: 2025/09/18 20:27:30 by ebalana-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	t_vec3 normal, t_vec3 object_color)
{
	...
	diffuse = vec_scale(light_contribution, light_intensity * \
	...
	t_vec3 hit_point, t_vec3 normal)
{
	...
	{
		diffuse = calculate_diffuse_lighting(scene, hit_point, normal, \
			object_color);
